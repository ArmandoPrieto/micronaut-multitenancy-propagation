http://gorm.grails.org/6.1.x/hibernate/manual/#dataServices[GORM Data Services] take the work out of implemented service layer logic by adding the ability to automatically implement abstract classes or interfaces using GORM logic.
